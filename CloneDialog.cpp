...
CloneDialog::CloneDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BoxSizer2->Add(Origin, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer3->Add(Directory, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer1->Add(StdDialogButtonSizer1, 1, wxALL|wxEXPAND, 0);
	SetSizer(BoxSizer1);
	BoxSizer1->Fit(this);
	BoxSizer1->SetSizeHints(this);

	Connect(ID_BROWSE,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&CloneDialog::OnBrowseClick);
	//*)
}
...
void CloneDialog::OnBrowseClick(wxCommandEvent& event)
{
